...
function EndScene() {
  return <section className="cinema-scene center end-frame"><h1>Today: six robots in a lab. Tomorrow: cranes, robot cells and autonomous machines in production.</h1><p>Veyra becomes the decision system of record for Physical AI.</p><div className="market-proof"><span>Physical AI momentum</span><b>79% engaging · 27% deploying or scaling</b><small>Capgemini Research Institute, 2026</small></div><div className="unlock-row"><div><span>Decision reconstruction</span><b>What changed</b></div><div><span>Decision record</span><b>Who approved</b></div><div><span>Outcome intelligence</span><b>What worked</b></div><div><span>Governance</span><b>What future autonomy inherits</b></div></div><Link className="button lime" href={`/investigations/${INVESTIGATION_ID}`}>Open live system</Link></section>;
}
