      ...
      <main className="main">
        ...
        <section className="investigation panel">
          ...
          <div className="backend-grid">
            ...
            <b>sealed Decision Package</b>
            <b>outcome-linked memory</b>
          </div>
        </section>
        <section className="investigation panel">
          ...
          <p>Evidence → What changed → Where else → Compare → Decision → Outcome → Memory.</p>
